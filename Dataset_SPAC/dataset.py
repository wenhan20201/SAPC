...
class VideoDataset:
    def __init__(self, args):
        ...
        self.path_to_descriptors = os.path.join(args.descriptors_root, self.dataset_name + "-Descriptors/")
        ...
        self.appearance_descriptors = np.load(self.path_to_descriptors + "general_appearance_descriptors.npy", allow_pickle=True)
        self.motion_descriptors = np.load(self.path_to_descriptors + "general_motion_descriptors.npy", allow_pickle=True)
    ...
    def get_appearance_descriptors(self):
        return self.appearance_descriptors
    
    def get_motion_descriptors(self):
        return self.motion_descriptors
